                              ...
                              <div className="rates-table-container">
                                {editingSupplier === supplier.id ? (
                                  ...
                                  <table className="rates-table">
                                    ...
                                    <tbody>
                                      {(supplier.roomTypes || ['Standard Room', 'Deluxe Room', 'Suite']).map((roomType, index) => (
                                        <tr key={index}>
                                          <td>{roomType}</td>
                                          <td>
                                            <input 
                                              type="text" 
                                              placeholder="Php 0.00"
                                              defaultValue={supplier.rates?.[roomType]?.publish || ''}
                                              disabled
                                            />
                                          </td>
                                          <td>
                                            <input 
                                              type="text" 
                                              placeholder="Php 0.00"
                                              defaultValue={supplier.rates?.[roomType]?.contracted || ''}
                                              disabled
                                            />
                                          </td>
                                          <td>
                                            <input 
                                              type="text" 
                                              placeholder="Php 0.00"
                                              defaultValue={supplier.rates?.[roomType]?.corporate || ''}
                                              disabled
                                            />
                                          </td>
                                          <td>
                                            <input 
                                              type="text" 
                                              placeholder="Php 0.00"
                                              defaultValue={supplier.rates?.[roomType]?.selling || ''}
                                              disabled
                                            />
                                          </td>
                                        </tr>
