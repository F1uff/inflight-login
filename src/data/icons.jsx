...
export const Icons = {
  dashboard: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm0 6h4v-4h-4v4zm-8 0h4v-4H4v4zm8 6h4v-4h-4v4z"/>
    </svg>
  ),
  notification: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  // Transport Dashboard specific icons
  dataRegistration: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>
    </svg>
